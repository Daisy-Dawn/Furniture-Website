...
const ProductDetails = () => {
  ...
  useEffect(() => {
    ...
    // Only render ProductNotFound if loading has finished and there's no product
    if (!loading && !product) {
        ...
        <section className='flex gap-10 flex-col'>
          ...
          <div className='flex justify-between items-center gap-1 flex-wrap'>
            ...
            <div className='flex gap-3 items-center'>
              ...
              <h2 className='text-base md:text-lg text-lead'>
                {' '}
                {product.starRating}{' '}
              </h2>
          ...
          <section className='flex flex-wrap gap-4'>
            <div className='flex border-2 rounded-[0.625rem] border-brown p-2 gap-6 items-center'>
              ...
              <p className='text-lead font-bold text-base md:text-xl'>
                {quantityCount}
              </p>
              <button
            ...
            <button
              ...
              className={`${
                quantityCount === 0
                  ? 'disabled:bg-steam cursor-not-allowed'
                  : 'bg-lead'
              } py-[8px] px-[20px]  rounded-[10px] font-nunito  hover:bg-stone-600 text-white text-base lg:text-xl font-bold text-center flex items-center justify-center transition-all duration-300 `}
              disabled={quantityCount === 0 ? true : false}
            >
              Add To Cart
            </button>
