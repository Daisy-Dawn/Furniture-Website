  ...
  return (
    ...
    >
      <Link className='w-full' to={link}>
        <div className='group transition-all duration-300 relative w-full md:min-w-[16.75rem] md:max-w-[18.75rem] h-[18.75rem] rounded-[10px] flex items-center justify-center overflow-hidden'>
          {/* <div> */}
          <img
