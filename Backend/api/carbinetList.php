...
switch ($method) {
    case 'GET':
        ...
        if (isset($path[4]) && is_numeric($path[4])) {
            ...
            $allProduct = mysqli_query($db_connect, "SELECT * FROM carbinetlist");
    ...
    case 'POST':
        if (isset($_FILES['image'])) {
            ...
            $result =  "INSERT INTO carbinetlist (name, price, ratings, category, description, image, tag, color, formerprice, feature, peopleratings, productname, productdetails ) VALUES ('$name', '$price', '$ratings', '$category', '$description', '$image', '$tag', '$color', '$formerprice', '$feature', '$peopleratings', '$productname', '$productdetails' ) ";
